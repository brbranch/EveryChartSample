...
type TextFieldProps = InternalTextFieldProps & FieldProps

class Component extends BaseInputField<InternalTextFieldProps> {
    render () {
...
type OwnProps = TextFieldProps & Classes

export const InputText : React.FC<TextFieldProps> = (props: TextFieldProps) => {
